...
import { saveDelegation } from 'Frontend/middleware/DelegationEndpoint';
...
export default function DelegationView() {
  const handleSaveDelegation = async () => {
    try {
      await saveDelegation(sampleDelegation);
  ...
  return (
    <div className="flex flex-col h-full items-center justify-center p-l text-center box-border">
      <img style={{ width: '200px' }} src="images/empty-plant.png" alt="Delegation" />
